...
public class PrometheusQConfigGauge extends SimpleCollector<PrometheusQConfigGauge.Child> implements Collector.Describable {

    PrometheusQConfigGauge(Builder b) {
        super(b);
    }
    ...
    public static class Builder extends SimpleCollector.Builder<Builder, PrometheusQConfigGauge> {
        @Override
        public PrometheusQConfigGauge create() {
            return new PrometheusQConfigGauge(this);
        }
    }
