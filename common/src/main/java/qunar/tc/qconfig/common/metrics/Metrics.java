...
public class Metrics {
    ...
    private static final QConfigMetricRegistry INSTANCE;

    static {
        ServiceLoader<QConfigMetricRegistry> registries = ServiceLoader.load(QConfigMetricRegistry.class);
        QConfigMetricRegistry instance = null;
        for (QConfigMetricRegistry registry : registries) {
            instance = registry;
            break;
        }
        if (instance == null) {
    ...
    public static QConfigCounter counter(String name, String[] tags, String[] values) {
        return INSTANCE.newCounter(name, tags, values);
    }

    public static QConfigCounter counter(String name) {
        return INSTANCE.newCounter(name, EMPTY, EMPTY);
    }

    public static QConfigMeter meter(String name, String[] tags, String[] values) {
        return INSTANCE.newMeter(name, tags, values);
    }

    public static QConfigMeter meter(String name) {
        return INSTANCE.newMeter(name, EMPTY, EMPTY);
    }

    public static QConfigTimer timer(String name, String[] tags, String[] values) {
        return INSTANCE.newTimer(name, tags, values);
    }

    public static QConfigTimer timer(String name) {
